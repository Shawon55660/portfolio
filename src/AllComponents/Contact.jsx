    ...
    return (
        <div>
            ...
            <Zoom><div className='text-center flex flex-col p-4 shadow-lg rounded-md bg-gray-50'>
                   ...
                   <img className='mx-auto w-full shadow-inner rounded-full    p-2' src="https://img.icons8.com/?size=100&id=14181&format=png&color=4ade80" alt="" />
                   
                   </div>
                    <h2 className='text-xl font-semibold text-gray-700 py-2 capitalize'>Phone</h2>
                    </div>
                    <p className=' text-gray-600 font-mono py-1'>+8801912843658</p>
                </div></Zoom>
                <Zoom><div className='text-center flex flex-col p-4 shadow-lg rounded-md bg-gray-50'>
                    <div className=''>
                   <div className='bg-white w-12 mx-auto rounded-full shadow-inner transition-all hover:shadow-xl'>
                   <img className='mx-auto w-full shadow-inner rounded-full    p-2' src="https://img.icons8.com/?size=100&id=60688&format=png&color=4ade80" alt="" />
                ...
                <Zoom><div className='text-center flex flex-col p-4 shadow-lg rounded-md bg-gray-50'>
                    <div className=''>
                   <div className='bg-white w-12 mx-auto rounded-full shadow-inner transition-all hover:shadow-xl'>
                   <img className='mx-auto w-full shadow-inner rounded-full    p-2' src="https://img.icons8.com/?size=100&id=53430&format=png&color=4ade80" alt="" />
                   
                   </div>
                    <h2 className='text-xl font-semibold text-gray-700 py-2 capitalize'>Address</h2>
                    </div>
                    <p className=' text-gray-600 font-mono py-1'>Kushtia, Khulna, Bangladesh</p>
                </div></Zoom>
